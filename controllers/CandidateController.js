...
//https://pinnacle-recruiting.herokuapp.com/
    CandidateALLINFO.forEach(function (INFO) {
        ...
        var message = {
            ...
            <h4>We would like to invite you to interview for the role by joining this <a href="http://localhost:3000/Interview_welcome_screen/${e}/${CandidateDocId}/${INFO.CandidateID}">link,</a> make sure to open the interview through Google Chrome Browser.</h4>\
